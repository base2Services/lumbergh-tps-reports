query "ec2_public_instances_with_unrestricted_ssh_details" {
  title       = "EC2 instances with public IPs and unrestricted SSH (details)"
  description = "Detailed view of EC2 instances with public IPs and unrestricted SSH access."
  ...
  sql = <<-EOQ
    ...
    SELECT
      ...
      i.public_ip_address,
      i.vpc_id,
      array_to_string(i.security_group_ids, ', ') as security_groups,
      'High' as severity
    FROM
